            ...
            <div class="ps-form__content">
                ...
                <div class="form-group">
                    <input class="form-control" type="password" name="password" id="txt-password"
                           autocomplete="new-password" placeholder="{{ __('Mật khẩu') }}">
                ...
                <div class="form-group">
                    <p class="text-center">{{ __('Bạn đã có tài khoản?') }}
                        <a href="{{ route('customer.login') }}" class="d-inline-block">{{ __('Đăng nhập') }}</a>
                    </p>
                </div>
            </div>
